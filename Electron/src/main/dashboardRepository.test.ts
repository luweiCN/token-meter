...
// v3 schema fixture. overview() reads the rollup tables (daily_rollup, session_rollup)
// built by Swift's RollupBuilder from usage_events. The v1 provider_daily_usage table and
// the dailyUsage() query that read it were removed in Task 18.
